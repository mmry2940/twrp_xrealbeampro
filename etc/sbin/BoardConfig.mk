...
TARGET_BOARD_PLATFORM := qcom               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := X4000     # From ro.product.board
...
BOARD_FLASH_BLOCK_SIZE := 0                   # Might be different for yo
...
TW_BRIGHTNESS_PATH := /sys/class/leds/led:switch_0/brightness
